...
export const metadata: Metadata = {
  title: "BLU-NOVA Tech Company - Transform Your Business with Intelligent Solutions",
  description:
    "Africa's leading provider of reliable, secure, and customer-focused tech solutions. We innovate and deliver scalable digital solutions that transform businesses.",
  keywords: "software development, web applications, mobile apps, custom systems, Africa, Kenya, tech solutions",
}
