...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className={`${getBackgroundColor()} shadow-md fixed w-full top-0 z-10 transition duration-500`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          <div className="flex-shrink-0 flex items-center">
            <Link className='flex items-center' href="/">
              <img src="/BLU-BG-LESS.png" alt="Logo" className='w-[50px] h-[50px]' />
              <p className="text-xl font-bold text-white">BLU NOVA</p> {/* Adjusted text color to ensure visibility */}
            </Link>
          </div>
